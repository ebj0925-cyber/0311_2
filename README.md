...
<p align="center">
  <img src="./img/slider/slider2.jpg" alt="풀무원 쇼핑몰 메인 비주얼" width="780" />
</p>
...
<table>
  <tr>
    <td width="50%" align="center">
      ...
      <br />
      <sub>브랜드 메시지를 크게 보여주는 히어로 캐러셀 영역</sub>
    </td>
    <td width="50%" align="center">
  ...
  <tr>
    <td width="50%" align="center">
      ...
      <strong>상품 상세</strong>
      <br />
      <sub>상품 이미지, 가격, 옵션, 수량 선택 UI를 구성</sub>
    </td>
    <td width="50%" align="center">
      ...
      <br />
      <sub>브랜드별 상품 묶음과 상품 카드 레이아웃</sub>
    </td>
  </tr>
</table>
...
│   ├── layout.css      # 공통 레이아웃 및 반응형 보정
│   ├── main.css        # 메인 페이지 스타일
│   └── sub.css         # 상품 상세 페이지 스타일
├── js/
│   ├── slider.js       # 메인 슬라이드 렌더링 및 자동 재생
│   ├── quick_menu.js   # 퀵 메뉴 데이터 렌더링
│   ├── 01_fetch_*.js   # 섹션별 상품 데이터 렌더링
│   ├── 08_fetch_brand.js
│   └── sub.js          # 상품 상세 데이터 렌더링
├── json/
│   ├── slider.json
│   ├── quick_menu.json
│   ├── 01_recommend.json
